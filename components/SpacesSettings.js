...
export default function SpacesSettings({ slug, spaces: initial }) {
  ...
  return (
    <div className="card space-y-4 p-4 sm:p-6">
      <div>
        <h2 className="font-semibold text-gray-900 dark:text-gray-100">Estaciones</h2>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Mínimo 1, máximo 20.</p>
      </div>

      {spaces.length > 0 && (
        <div className="space-y-2 border-t border-gray-100 pt-4 dark:border-gray-800">
          <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Nombres</p>
          {spaces.map((space) => (
