import { BOOKING_REJECTED_TITLE, BOOKING_REJECTED_BODY } from "./constants";
...
export function formatTime(date) {
  ...
  const suffix = dayPeriod.startsWith("p") ? "pm" : "am";
...
export function getAppointmentStatusLabel(apt) {
  if (apt.status === "pending") return "Pendiente de aprobación";
